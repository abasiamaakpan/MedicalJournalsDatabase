...
```{r}
grabbing_index <- tibble::rowid_to_column(journals_df, "articleID")
#grabbing_index
#articlel
...
# load articles table
res <- dbSendQuery(con, "INSERT INTO articles (article_id, journal_id, pub_model, title, pub_date, lang) VALUES (:ArticleID, :JournalID, :PubModel, :Agency, :Country);", grants_df)
