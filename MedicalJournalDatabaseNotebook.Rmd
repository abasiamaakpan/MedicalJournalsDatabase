...
```{r}
# load journals
res <- dbSendQuery(con, "INSERT INTO journals (journal_id, pub_model, title, pub_date, lang) VALUES (:journalID, :ISSN, :Volume, :Issue, :PubDate, :title, :ISOAbbrev);", article_journal_initial_df)
...
```{r}
# load articles
res <- dbSendQuery(con, "INSERT INTO articles (abstract_id, index, label, nml_category, content) VALUES (:name, :index, :label, :nlmCategory, :content);", author_list_df)
