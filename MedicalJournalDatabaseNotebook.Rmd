...
# load authors table
res <- dbSendQuery(con, "INSERT INTO authors (author_id, last_name, first_name, initials) VALUES (:authorID, :LastName, :FirstName, :Initial);", authors_df)
...
CREATE TABLE AuthorDim
  AS SELECT author_id, last_name, first_name, initials, affiliation FROM authors;
```
```{sql, connection=con}
-- show table was correctly loaded
SELECT * 
